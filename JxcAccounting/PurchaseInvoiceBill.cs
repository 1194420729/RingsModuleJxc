...
{
    public class PurchaseInvoiceBill : MarshalByRefObject
    {
        private string billname = "purchaseinvoicebill";
        ...
        public Object GetInvoiceBills(string parameters)
        {
            ...
            DBHelper db = new DBHelper();
            string sql = "select * from bill where content->>'billname' in ('purchasebill','purchasebackbill') " +
