...
namespace JxcAccounting
{
    public class SaleInvoiceReport : MarshalByRefObject
    {
        ...
        public Object SaleInvoiceBillReport(string parameters)
        {
            ...
            string sqlCount = cte+"select count(0) as cnt from (select customerid from cte "+
                                sb.ToString()+
        ...
        public Object SaleInvoiceBillReportDetail(string parameters)
        {
            ...
            string sqlCount = "select count(0) from mvw_saleinvoicebill "
                            + sb.ToString();
        ...
        public Object SaleUnInvoiceBillReport(string parameters)
        {
            ...
            string sqlCount = "select count(0) as cnt from (select customer.id from bill inner join customer on (bill.content->>'customerid')::int=customer.id " +
                                sb.ToString() +
