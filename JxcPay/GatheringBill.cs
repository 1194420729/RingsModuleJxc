...
namespace JxcPay
{
    public class GatheringBill : MarshalByRefObject
    {
        private string billname = "gatheringbill";
        ...
        public Object GetCheckoutBills(string parameters)
        {
            ...
            DBHelper db = new DBHelper();
            string sql = "select * from bill where content->>'billname' in ('salebill','salebackbill','incomebill') " +
        ...
        public Object GatheringBillQuery(string parameters)
        {
        ...
        public Object LoadBill(string parameters)
        {
            ...
            {
                item.Add("bank", db.First("bank", item.Value<int>("bankid")).content);
            }
