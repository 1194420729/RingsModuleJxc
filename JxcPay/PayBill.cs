...
namespace JxcPay
{
    public class PayBill : MarshalByRefObject
    {
        private string billname = "paybill";
        ...
        public Object PayBillQuery(string parameters)
        {
        ...
        public Object RegisterPrintModel(string parameters)
        {
            ...
            pd.HeaderValue = new Dictionary<string, string>()
            {
                ...
                {"付款金额",total.ToString("n2")},
                {"付款金额大写",MoneyHelper.ConvertSum(total)} 
            };
